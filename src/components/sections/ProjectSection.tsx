...
export const ProjectSection = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      if (projectSectionRef.current && projectCardRef.current) {
  ...
  return (
    <section id="work" ref={projectSectionRef} className="h-screen w-full flex items-center justify-center relative bg-[#0a0f1a] overflow-hidden z-20">
